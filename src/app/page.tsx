  ...
  return (
    <main className="bg-black text-white font-sans flex flex-col h-screen overflow-hidden">
      ...
      <header className="p-4 md:p-6 border-b border-gray-800 z-10 shrink-0 text-center">
        ...
        <a
          href="https://music.apple.com/us/artist/dj-friend/1790055389"
          target="_blank"
          rel="noopener noreferrer"
          className="text-pink-400 hover:text-pink-300 font-mono text-sm transition-colors duration-200 inline-flex items-center gap-1 ml-4"
        >
          <span>listen on apple music</span>
          <Image src="/apple_music_icon.svg" alt="Apple Music" width={16} height={16} className="inline-block align-text-bottom" />
        </a>
      </header>
